  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6">
        <h2 className="text-2xl font-bold mb-4 text-violet-700 dark:text-violet-200">✂️📄 PDF Splitter</h2>
        <input
          type="file"
          accept=".pdf"
          className="mb-4"
        ...
        <button
          ...
          disabled={!file}
          onClick={() => setResult("यहाँ splitted PDF files के डाउनलोड लिंक दिखेंगे (demo)")}>
          Split PDF
        </button>
        {result && (
